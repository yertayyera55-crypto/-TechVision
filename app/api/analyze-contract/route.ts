...
const fixedAnalysisPrompt = `Проанализируй текст договора поставки для предварительного заполнения заявки на факторинг.
...
- factoringReady=false, если для предварительной заявки не хватает существенных данных.
