...
const timeline = [
  ...
  { title: "Анкета FlowFactor", note: "Поставщик подтвердил автоматически заполненные данные" },
  ...
  { title: "Демопредложение выбрано", note: "Выбран синтетический финансовый партнёр" },
  { title: "Срок оплаты покупателя", note: "В реальности оплату получает финансовый партнёр" },
];
...
const currentIndex: Record<ApplicationStatus, number> = {
  ...
  ready_for_signing: 4,
  transferred: 5,
  financing_received: 6,
  awaiting_buyer_payment: 6,
  partially_paid: 6,
  payment_overdue: 6,
  recourse_approaching: 6,
  closed: 6,
  paid: 6,
  rejected: 4,
};
