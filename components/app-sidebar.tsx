...
const navigation = [
  ...
  { href: "/payments-monitoring", label: "Сроки оплаты", icon: CircleDollarSign },
...
export function AppSidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-[248px] flex-col border-r border-line bg-paper/95 px-5 py-7 backdrop-blur-sm lg:flex">
      <div className="px-2"><Logo /><EducationalMvpNotice compact /></div>
      ...
      <div className="space-y-2 border-t border-line pt-4">
        <a href="mailto:support@flowfactor.demo" className="flex min-h-10 items-center gap-3 rounded-lg px-3 text-xs font-medium text-moss-700 transition hover:bg-moss-50">
