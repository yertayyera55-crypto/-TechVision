...
const statuses: Record<ApplicationStatus, { label: string; className: string }> = {
  ...
  precheck_passed: { label: "Предварительно соответствует условиям", className: "bg-lime-100 text-lime-900 ring-lime-200" },
  transferred: { label: "Демопредложение принято", className: "bg-blue-100 text-blue-900 ring-blue-200" },
  financing_received: { label: "Демонстрационное финансирование перечислено", className: "bg-indigo-100 text-indigo-900 ring-indigo-200" },
